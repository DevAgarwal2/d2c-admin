           ...
           <form id="product-form" className="max-w-4xl mx-auto space-y-6">
             ...
             <input type="hidden" name="image" id="image-input" value={imageUrl} />
              ...
              <Card className="shadow-sm">
                ...
                <CardContent className="space-y-4">
                  <input type="hidden" id="size-variants-input" name="size_variants" />
                  ...
                  {hasSizes && (
                    <div className="space-y-3 border-t border-slate-100 pt-4">
                      <p className="text-xs text-slate-500">Define size variants with features:</p>
                      {sizeVariants.map((variant, index) => (
                        <div key={index} className="p-4 bg-slate-50 rounded-lg space-y-3">
                          {/* Row 1: Name, Size, Price, Stock */}
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              <Input
                                ...
                                placeholder="e.g., Wooden Hanging Planter"
                          ...
                          {/* Features for this size */}
                          <div>
                            <Label className="text-xs text-slate-500">Features (one per line)</Label>
                            <textarea
                              value={variant.features?.join('\n') || ''}
                              onChange={(e) => {
                                const newVariants = [...sizeVariants];
                                newVariants[index].features = e.target.value.split('\n').filter(f => f.trim());
                                setSizeVariants(newVariants);
                              }}
                              placeholder="e.g., Height: 10cm&#10;Weight: 500g&#10;Material: Brass"
                              className="w-full min-h-[80px] px-3 py-2 text-sm border border-slate-200 rounded-md bg-white focus-visible:ring-slate-400 focus-visible:outline-none resize-y mt-1"
                            />
                          </div>
                          ...
                          <Button
                            ...
                            className="w-full h-8 text-red-500 hover:text-red-700 hover:bg-red-50"
                          >
                            <X className="w-4 h-4 mr-1" /> Remove this size
                          </Button>
                        </div>
                      ))}
                      ...
                      <Button
                        ...
                        className="w-full"
                        onClick={() => {
                          setSizeVariants([...sizeVariants, { name: '', size: '', price: 0, in_stock: true, features: [''] }]);
                        }}
                      >
                        + Add Size Variant
                      </Button>
